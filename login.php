  ...
  <h5>LOGIN KOKERU</h5>
	<form method="POST" autocomplete="on" action="">
		<div class="form-group">	
			...
			<div class="error" style="color:red"><?php if (isset($error_email)) print_r( $error_email;?></div>
		</div>
		<div class="form-group">
			<label for="password">Password :</label>
			<input type="password" class="form-control" id="password" name="password" size="30" value="">
			<div class="error" style="color:red"><?php if (isset($error_password)) print_r( $error_password;?></div>
		</div>
		<button type="submit" class="btn btn-primary" name="submit" value="submit">Login</button>
		<div class="error" style="color:red"><?php if (isset($error_akun)) print_r( '<br>'.$error_akun;?></div>
		<hr>
