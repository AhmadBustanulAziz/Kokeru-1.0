      ...
      <ul class="nospace group" style="color:white">
		<?php  	
			$i = 0;
				...
				print_r($ruser['nama']);
				print_r('</p>');
				print_r('<footer><a class="btn btn-success btn-sm" href="update_ruang_cs.php?id_laporan='.$rlaporan['id_laporan'].'">Update</a></footer>');
				print_r('</article>');
				print_r('</li>');
				$i = $i+1;			
			while ($row = $qlaporan->fetch_object()){
				...
				print_r($ruser['nama']);
				print_r('</p>');
				print_r('<footer><a class="btn btn-success btn-sm" href="update_ruang_cs.php?id_laporan='.$row->id_laporan.'">Update</a></footer>');
				print_r('</article>');
				print_r('</li>');
				$i = $i+1;
			}
